...
class AndroidProjectTests(unittest.TestCase):
    ...
    def test_web_bridge_hooks(self):
        ...
        self.assertIn("sendFolder", app_js)
        self.assertIn("sendBlockchainSync", app_js)
        self.assertIn("receiveBlockchainSync", app_js)
        self.assertIn("importSyncPack", app_js)
        self.assertIn("/api/sync", app_js)
        self.assertIn("ApertureAndroid.shareSync", app_js)
        self.assertIn("ApertureAndroid.receiveSync", app_js)
        self.assertIn("aperture-native-sync-error", app_js)
        self.assertIn("aperture-native-vault", app_js)
    ...
    def test_recent_plates_in_opener(self):
        ...
        self.assertIn("Send this folder", html)
        self.assertIn("Send folder", html)
        self.assertIn("Receive folder", html)
        self.assertIn('id="sendBar"', html)
        self.assertIn('id="openerReceiveBtn"', html)
        self.assertIn("send-bar", css)
        self.assertIn('id="syncInput"', html)
        self.assertIn(".apsync", html)
    ...
    def test_native_cache_keys(self):
        ...
        self.assertIn("/api/sync", main)
        self.assertIn("fun shareSync", main)
        self.assertIn("fun receiveSync", main)
        self.assertIn("fun writeSyncPack", store)
        self.assertIn("fun receiveSyncBytes", store)
        self.assertIn("fun receiveSyncUri", store)
        self.assertIn("mergeChains", store)
        self.assertIn("SYNC_MAGIC", store)
        self.assertIn(".apsync", store)
        self.assertIn("importChainFromTree", store)
        self.assertIn("ACTION_SEND", main)
        self.assertIn("importIncoming", main)
        ...
        self.assertIn("application/x-aperture-sync", manifest)
