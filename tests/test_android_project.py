...
class AndroidProjectTests(unittest.TestCase):
    ...
    def test_web_bridge_hooks(self):
        ...
        self.assertIn("encodeCatalogOnXrp", app_js)
        self.assertIn("encodePhotoOnXrp", app_js)
        self.assertIn("/api/xrp", app_js)
        self.assertIn("ApertureAndroid?.xrpEncode", app_js)
        self.assertIn("ApertureAndroid?.xrpDecode", app_js)
        self.assertIn("decodeXrpSpot", app_js)
        self.assertIn("/api/xrp/decode", app_js)
        self.assertIn("/api/xrp/spot", app_js)
        xrp_js = (ROOT / "js" / "xrp.js").read_text(encoding="utf-8")
        self.assertIn("aperture-xrp-cipher-v1", xrp_js)
        self.assertIn("aperture-xrp-spot-v1", xrp_js)
        self.assertIn("classicAddress", xrp_js)
        self.assertIn("encodePlate", xrp_js)
        self.assertIn("encodeSpot", xrp_js)
        self.assertIn("decodeSpot", xrp_js)
        self.assertIn("apxs1:", xrp_js)
        self.assertIn("MEMO_TYPE", xrp_js)
    ...
    def test_recent_plates_in_opener(self):
        ...
        self.assertIn('id="xrpLedger"', html)
        self.assertIn("Encode onto XRP", html)
        self.assertIn('id="xrpBar"', html)
        self.assertIn('id="xrpBtn"', html)
        self.assertIn('id="xrpSpotInput"', html)
        self.assertIn("Decode spot", html)
        self.assertIn("apxs1:", html)
        self.assertIn("xrp-ledger", css)
        self.assertIn("xrp-spot-field", css)
        self.assertIn("xrp-bar", css)
    ...
    def test_native_cache_keys(self):
        ...
        self.assertIn("/api/xrp", main)
        self.assertIn("fun xrpEncode", main)
        self.assertIn("fun xrpDecode", main)
        self.assertIn("fun xrpEncode", store)
        self.assertIn("fun xrpDecode", store)
        self.assertIn("fun xrpEncodeFolder", store)
        self.assertIn("fun encodeXrpSpot", store)
        self.assertIn("fun decodeXrpSpot", store)
        self.assertIn("/api/xrp/spot", main)
        self.assertIn("/media/xrp/", main)
        self.assertIn("KEY_XRP", store)
        self.assertIn("aperture-xrp-cipher-v1", store)
        self.assertIn("aperture-xrp-spot-v1", store)
        self.assertIn("apxs1:", store)
