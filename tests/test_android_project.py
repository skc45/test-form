...
class AndroidProjectTests(unittest.TestCase):
    ...
    def test_web_bridge_hooks(self):
        ...
        self.assertIn("initializeShardSearch", app_js)
        self.assertIn("searchCatalogOnServer", app_js)
        self.assertIn("/api/search", app_js)
        self.assertIn("ApertureAndroid?.searchCatalog", app_js)
    ...
    def test_recent_plates_in_opener(self):
        ...
        self.assertIn("Search titles, places, recents", html)
    ...
    def test_native_cache_keys(self):
        ...
        self.assertIn("/api/search", main)
        self.assertIn("fun searchCatalog", main)
        self.assertIn("fun searchCatalog", store)
        self.assertIn("fun searchResponse", store)
